...
public class DogUntameConfirmScreen extends Screen {
	...
	public void render(GuiGraphics graphics, int mouseX, int mouseY, float pTicks) {
		...
		help = I18n.get("doggui.detrain.confirm.subtitle", dog.getName().getString());
		var dog_title = I18n.get("doggui.invalid_dog.info.dog", dog.getName().getString());
		var owner_title = I18n.get("doggui.invalid_dog.info.owner",
	...
	private void addUntameButton() {
		var untameButton = new CustomButton(this.width / 2 - 25, this.height / 2 + 58, 50, 20,
				Component.translatable("doggui.untame.confirm.confirmed"), b -> {
					requestUntame();
			...
			public void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float pTicks) {
				...
				String costStr;
				int costStrColor;
				costStr = I18n.get("doggui.talents.cost") + AmnesiaBoneItem.UntameXPCost;
				...
				this.active = (player != null && player.experienceLevel >= AmnesiaBoneItem.UntameXPCost);
			}
			...
			public void render(GuiGraphics graphics, int mouseX, int mouseY, float pTicks) {
				...
				if (this.active) {
					...
					var player = Minecraft.getInstance().player;
					if (player != null && player.experienceLevel < AmnesiaBoneItem.UntameXPCost) {
		...
		var player = Minecraft.getInstance().player;
		untameButton.active = (player != null && player.experienceLevel >= AmnesiaBoneItem.UntameXPCost);
