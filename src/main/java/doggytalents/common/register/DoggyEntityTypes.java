...
// line 2 "../../../register_entitytype.ump"
public class DoggyEntityTypes {
	...
	public static final DeferredRegister<EntityType<?>> ENTITIES = DeferredRegister
			.create(ForgeRegistries.Keys.ENTITY_TYPES, Constants.MOD_ID);
	...
	public static final RegistryObject<EntityType<DoggyBeamEntity>> DOG_BEAM = register("dog_beam",
...
//			b -> b.sized(3f, 3f).setUpdateInterval(4).setTrackingRange(10).setShouldReceiveVelocityUpdates(false));
	...
	public static final RegistryObject<EntityType<DogFoodProjectile>> DOG_FOOD_PROJ = register("dog_food_projectile",
			DogFoodProjectile::new, MobCategory.MISC,
			(b) -> b.sized(0.25F, 0.25F).setUpdateInterval(4).setTrackingRange(10).setShouldReceiveVelocityUpdates(true)
					.setCustomClientFactory(DogFoodProjectile::new).noSummon());
	public static final RegistryObject<EntityType<DogGunpowderProjectile>> DOG_GUNPOWDER_PROJ = register(
	...
	public static void addEntityAttributes(EntityAttributeCreationEvent e) {
		e.put(DOG.get(),
				Mob.createMobAttributes().add(Attributes.MAX_HEALTH, 8.0D).add(Attributes.MOVEMENT_SPEED, 0.3D)
						.add(Attributes.KNOCKBACK_RESISTANCE, 0.25D).add(Attributes.ATTACK_DAMAGE, 2.0D)
						.add(DoggyAttributes.JUMP_POWER.get(), 0.42D).add(DoggyAttributes.CRIT_CHANCE.get(), 0.01D)
						.add(DoggyAttributes.CRIT_BONUS.get(), 1D).add(Attributes.FLYING_SPEED, 0.3D).build());
	}
